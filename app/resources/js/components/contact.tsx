  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl md:text-5xl font-bold text-blue-900 mb-8 text-center">Contact Us</h1>
        
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h2 className="text-2xl font-semibold text-blue-800 mb-4">Get in Touch</h2>
            <p className="text-blue-700 mb-6">We're here to help and answer any question you might have. We look forward to hearing from you!</p>
            ...
            <form className="space-y-4">
              ...
              <div>
                <label htmlFor="subject" className="block text-sm font-medium text-blue-700">Subject</label>
                <Input type="text" id="subject" name="subject" required className="mt-1 block w-full" />
              </div>
              <div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-blue-700">support@ascendia.com</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
            ...
            <div className="mt-8">
              <h2 className="text-2xl font-semibold text-blue-800 mb-4">Follow Us</h2>
